...
class CapsLayer():
    def __init__(self, input_, num_outputs, out_len, r = 3, name = 'capsweights'):
        ...
        self.W = tf.get_variable(self.name, (self.input_caps_num, self.input_caps_len, num_outputs * out_len),
                                 initializer = tf.truncated_normal_initializer(stddev = self.num_outputs / self.input_caps_num))
        self.r = r
